...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AwesomeList)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__cdkJsiiProject)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"p6-projen-project-awesome-list.AwesomeListProjectOptions",
		reflect.TypeOf((*AwesomeListProjectOptions)(nil)).Elem(),
	)
}
